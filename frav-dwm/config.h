...
static const char *fonts[]                    = { "Iosevka Nerd Font:size=12", "NotoColorEmoji:pixelsize=16:antialias=true:autohint=true" };
static const char normbordercolor[]           = "#282a36";
static const char normbgcolor[]               = "#282a36";
static const char normfgcolor[]               = "#f8f8f2";
static const char selbordercolor[]            = "#505c85";
static const char selbgcolor[]                = "#505c85";
...
static const Layout layouts[] = {
    ...
    { "󱁐 ",      NULL },    /* no layout function means floating behavior */
    { " ",      monocle },
};
...
/* commands */
static const char *launchercmd[] = { "rofi","-combi-modi", "drun,window,filebrowser", "-show", "drun", NULL };
...
static Key keys[] = {
    ...
    { MODKEY|ShiftMask,             XK_w,                      spawn,          SHCMD ("feh --randomize --bg-fill ~/Pictures/Wallpaper/*")},
    { 0,                            XF86XK_MonBrightnessUp,    spawn,          SHCMD ("$HOME/scripts/brightnessup.sh")},
    { 0,                            XF86XK_MonBrightnessDown,  spawn,          SHCMD ("$HOME/scripts/brightnessdown.sh")},
    { 0,                            XF86XK_AudioLowerVolume,   spawn,          SHCMD ("$HOME/scripts/volumedown.sh")},
    { 0,                            XF86XK_AudioMute,          spawn,          SHCMD ("$HOME/scripts/volumetoggle.sh")},
    { 0,                            XF86XK_AudioRaiseVolume,   spawn,          SHCMD ("$HOME/scripts/volumeup.sh")},
    ...
    { MODKEY|ControlMask,           XK_q,                      spawn,          SHCMD("rofi -show power-menu -modi power-menu:$HOME/scripts/rofi-power-menu")},
